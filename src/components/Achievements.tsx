      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Our <span className="text-brandOrange">Achievements</span>
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-3xl font-bold text-white mb-6">
                Our <span className="text-brandOrange">Credibility</span>
              </h3>
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="w-2 h-2 bg-brandOrange rounded-full mt-2 flex-shrink-0"></div>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {clients.map((client, index) => (
                  <div key={index} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 text-center hover:border-brandOrange/30 transition-all duration-300">
                    <Building className="w-6 h-6 text-brandOrange mb-2 mx-auto" />
