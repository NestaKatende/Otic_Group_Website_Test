      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Let's Work <span className="text-brandOrange">Together</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/20 rounded-2xl p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4 group hover:translate-x-2 transition-transform duration-300">
                  <div className="w-12 h-12 bg-brandOrange/20 rounded-xl flex items-center justify-center group-hover:bg-brandOrange/30 transition-colors duration-300">
                    <Phone className="w-6 h-6 text-brandOrange" />
                  </div>
                  <div>
                ...
                <div className="flex items-center space-x-4 group hover:translate-x-2 transition-transform duration-300">
                  <div className="w-12 h-12 bg-brandOrange/20 rounded-xl flex items-center justify-center group-hover:bg-brandOrange/30 transition-colors duration-300">
                    <Mail className="w-6 h-6 text-brandOrange" />
                  </div>
                  <div>
                ...
                <div className="flex items-center space-x-4 group hover:translate-x-2 transition-transform duration-300">
                  <div className="w-12 h-12 bg-brandOrange/20 rounded-xl flex items-center justify-center group-hover:bg-brandOrange/30 transition-colors duration-300">
                    <Globe className="w-6 h-6 text-brandOrange" />
                  </div>
                  <div>
                ...
                <div className="flex items-center space-x-4 group hover:translate-x-2 transition-transform duration-300">
                  <div className="w-12 h-12 bg-brandOrange/20 rounded-xl flex items-center justify-center group-hover:bg-brandOrange/30 transition-colors duration-300">
                    <MapPin className="w-6 h-6 text-brandOrange" />
                  </div>
                  <div>
          ...
          <div className="bg-slate-800/30 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-brandOrange hover:brightness-110 text-white px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-brandOrange/25 flex items-center justify-center space-x-2"
              >
